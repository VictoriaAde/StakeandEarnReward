...
contract StakeContract {
    ...
    event WithdrawalSuccessful(address indexed user, uint256 indexed amount, uint256 indexed balance, uint256 when);
    ...
    function withdraw(uint256 _amount) external  {
        ...
        emit WithdrawalSuccessful(msg.sender, _amount, _userStakedBal, block.timestamp);
    }
